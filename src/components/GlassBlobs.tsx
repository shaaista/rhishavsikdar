...
const GlassPanel = ({ side, label, onClick }: { side: "left" | "right"; label: string; onClick?: () => void }) => {
  ...
  return (
    <div
      className="glass-button-wrap glass-button-wrap--3d w-[40%] md:w-[22%] h-full pointer-events-auto cursor-pointer"
    ...
    >
      ...
      >
        <span
          className="glass-button-text relative z-10 block select-none uppercase tracking-[0.15em] md:tracking-[0.3em] font-bold px-1 md:px-2 text-center text-[0.9rem] md:text-[1.4rem]"
...
const GlassBlobs = () => {
  ...
  return (
    <div className="fixed top-[32vh] md:top-auto bottom-auto md:bottom-[30vh] left-0 w-screen h-[5.5vh] md:h-[14vh] z-[5] pointer-events-none flex flex-row justify-center md:justify-between items-center gap-8 md:gap-0 px-4 md:px-12">
