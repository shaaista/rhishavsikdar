            ...
            <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 w-full max-w-6xl mx-auto">
              ...
              >
                <div className="relative rounded-[2rem] overflow-visible">
                  <div className="therapy-spin-border rounded-[2rem]" />
                  <div
              ...
              >
                ...
                >
                  A safe, sacred space to unravel, to feel, to become. Therapy is
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex flex-col gap-6 items-center">
                {approaches.map((item, i) => (
                  <motion.div
                    key={item.label}
                    className="relative w-full max-w-4xl rounded-2xl overflow-visible"
                    custom={i}
                    variants={fadeUp}
                    initial="hidden"
                    whileInView="visible"
                  ...
                  >
                    <div className="therapy-spin-border rounded-2xl" />
                    <div
                      className="relative px-12 md:px-16 py-6 md:py-8 rounded-2xl text-center"
                      style={{
                        background:
                          "linear-gradient(135deg, hsla(0,0%,100%,0.04) 0%, hsla(0,0%,100%,0.01) 100%)",
                        backdropFilter: "blur(20px)",
